...
VALUES ('Arraial do Cabo', 'Rio de Janeiro, Brasil', 'Conhecido como o Caribe brasileiro, com águas cristalinas e praias paradisíacas.', 9.2, 150),
       ('Chapada Diamantina', 'Bahia, Brasil', 'Parque nacional com cachoeiras, grutas e trilhas deslumbrantes no sertão baiano.', 8.8, 98),
       ('Florianópolis', 'Santa Catarina, Brasil', 'Ilha da Magia com mais de 40 praias, lagoas e rica cultura açoriana.', 8.5, 210),
       ('Lençóis Maranhenses', 'Maranhão, Brasil', 'Deserto de dunas brancas com lagoas de água doce azul-turquesa únicas no mundo.', 9.5, 175),
       ('Bonito', 'Mato Grosso do Sul, Brasil', 'Ecoturismo de alto nível com rios de água cristalina e rica biodiversidade.', 9.1, 132),
       ('Gramado', 'Rio Grande do Sul, Brasil', 'Cidade serrana com arquitetura europeia e clima frio.', 0.0, 0);
...
VALUES ('Arraial Completo', 'Passeio de barco, mergulho e praias em 5 dias.', 2500.00, 1),
       ...
       ('Gramado Completo', 'Passeio pela cidade, chocolate artesanal e neve artificial em 5 dias.', 3500.00, 6);
